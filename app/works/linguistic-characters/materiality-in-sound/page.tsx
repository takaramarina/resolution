...
export default function Home() {
  ...
  const artwork = {
    src: "/images/linguistic-characters/Materiality-in-Sound.webp",  // Image source
    highres: "/images/linguistic-characters/MaterialityInSound.jpg",
    title: "Reiji Shimane",
    artworkTitle: "Materiality in Sound",
